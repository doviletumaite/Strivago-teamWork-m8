...
var tokenAuth_js_1 = require("./tokenAuth.js");
var tokenAuthMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decodedToken, user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!req.headers.authorization) return [3 /*break*/, 6];
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
                token = req.headers.authorization.replace("Bearer ", "");
                return [4 /*yield*/, (0, tokenAuth_js_1.verifyToken)(token)];
            case 2:
